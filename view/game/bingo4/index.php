...
$ros = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_bingo4`"));
?>
...
@media    screen and (max-width: 580px) {
	...
	.game-list {
        ...
        background: url(https://quanlyshop.vip/upload/doanhmuc/1620758229191547.png) no-repeat;
    ...
    #slot3 {
        ...
        .a1 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/1623353816689242.png");
    }
        .a2 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/1623353816481480.png");
    }
        .a3 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/1623353816654406.png");
    }
        .a4 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/1623353816643472.png");
    }
        .a5 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/1623353816304396.png");
    }
        .a6 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/1623353816265261.png");
    }
        .a7 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/162335381614006.png");
    }
        .a8 {
        background-image: url("https://admin.shopanhhaivlog.vn/upload/doanhmuc/1623353816329722.png");
    }
...
<meta name="csrf-token" content="ukzEkN9kXqbUFz4UWIc8UqvyOe4JsLlF4lNOlOEk">
   <div class="container content-black">
    ...
    <div class="c-content-title-1 pd50">
        <h3 style="color:white" class="c-center c-font-uppercase c-font-bold">Bingo Chiến Binh Tối Thượng</h3>
        ...
        <div class="c-content-client-logos-slider-1  c-bordered" data-slider="owl">
            ...
            <div class="row-flex-safari game-list" style="margin-bottom: 40px">
               <main>
                ...
                <section id="Slots">
                    <div id="slot1" class=""><img id="role_1" style="width: 100%;" src="https://quanlyshop.vip/upload/doanhmuc/1620758229646196.png"></div>
                    <div id="slot2" class=""><img id="role_2" style="width: 100%;" src="https://quanlyshop.vip/upload/doanhmuc/1620758229646196.png"></div>
                    <div id="slot3" class=""><img id="role_3" style="width: 100%;" src="https://quanlyshop.vip/upload/doanhmuc/1620758229646196.png"></div>
                    </section>
                <section id="Gira">
         <img src="https://quanlyshop.vip/upload/settings/16208283725631310.png" id="quay">
        </section> 
            </main>
    ...
    <div class="col-lg-3 col-md-12 col-sm-12 btn-right" style="margin-top: 20px;">
        ...
        <a href="https://shopaccpro.tk/html/lichsuquay" class="col-xs-12 btn btn-success m-btn m-btn--custom m-btn--icon m-btn--pill">
            <span>
                <i class="la la-cloud-upload"></i>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        <?php
        for($i=1; $i <= 6; $i++) { 
echo '<img style="display: none;" src="/assets/img/bingo4/'.$i.'.png">';            
        }
?>
...
function change_img(id, img_name) {
        ...
        roll.src = "";
        roll.src = '/assets/img/bingo4/'+img_name+'.png';
}

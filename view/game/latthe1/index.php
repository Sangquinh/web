...
$ros = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_latthe1`"));
?>
	<style>
...
.transparent{
   ...
   <meta name="csrf-token" content="1BwwFmSzcIP0N7gwtVYxRqHGI8j1byQU8EkA0p7z"> 
   
    <div class="c-content-title-1 pd50"> 
     <h1 style="color:white" class="c-center c-font-uppercase c-font-bold">Lật Thẻ Hoa Phượng Mùa Hè</h1> 
         ...
         <section class="rotation"> 
          <div class="col-lg-12 boxflip" id="okmain"> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift1"> 
            <img id="img1" class="shake-image" src="/assets/img/latthe1/1.png"> 
            <img onclick="umbalaxibua('gift1', 'imgnen1')" id="imgnen1" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift2"> 
            <img id="img2" class="shake-image" src="/assets/img/latthe1/2.png"> 
            <img onclick="umbalaxibua('gift2', 'imgnen2')" id="imgnen2" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift3"> 
            <img id="img3" class="shake-image" src="/assets/img/latthe1/3.png"> 
            <img onclick="umbalaxibua('gift3', 'imgnen3')" id="imgnen3" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift4"> 
            <img id="img4" class="shake-image" src="/assets/img/latthe1/4.png"> 
            <img onclick="umbalaxibua('gift4', 'imgnen4')" id="imgnen4" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift5"> 
            <img id="img5" class="shake-image" src="/assets/img/latthe1/5.png"> 
            <img onclick="umbalaxibua('gift5', 'imgnen5')" id="imgnen5" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift6"> 
            <img id="img6" class="shake-image" src="/assets/img/latthe1/6.png"> 
            <img onclick="umbalaxibua('gift6', 'imgnen6')" id="imgnen6" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <!-- 7 --> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift7"> 
            <img id="img7" class="shake-image" src="/assets/img/latthe1/7.png"> 
            <img onclick="umbalaxibua('gift7', 'imgnen7')" id="imgnen7" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <!-- 8 --> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift8"> 
            <img id="img8" class="shake-image" src="/assets/img/latthe1/8.png"> 
            <img onclick="umbalaxibua('gift8', 'imgnen8')" id="imgnen8" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
           <div class="col-lg-4 col-md-3 col-sm-4 col-xs-6" id="gift9"> 
            <img id="img9" class="shake-image" src="/assets/img/latthe1/9.png"> 
            <img onclick="umbalaxibua('gift9', 'imgnen9')" id="imgnen9" class="shake-image" src="/assets/img/latthe1/upthe.png" style="display: none;"> 
           </div> 
          </div> 
          <div class="clearfix"></div> 
           <div class="col-sm-12 btn-right" style="margin-bottom: 0px;">
                                <a style="cursor: pointer; background: url(https://quanlyshop.vip/upload/settings/162092240584017857.gif); background-size: 220px 36px;width: 220px;" class="play sl-btnod hover-btn" id="chehinh"></a>
                            </div>
...
<p style="text-align:center"><span style="color:#f1c40f"><strong>Giải Thưởng Trị Giá Cao&nbsp;5000KC,12000KC,15000KC,20000KC,25000KC</strong></span></p>
    ...
    function umbalaxibua(selector, card) {
        ...
        roll.src = "";
        roll.src = '/assets/img/latthe1/upthe.png';

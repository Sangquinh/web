...
<?php
    ...
    $_bingo = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_latthe2`"));
...
$cmd = "UPDATE `setting_latthe2` SET
        `item_1` = '$item_1s',
        `item_2` = '$item_2s',
        `item_3` = '$item_3s',
        `item_4` = '$item_4s',
...
<div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h2 class="card-title"><b>CHỈNH SỬA TỈ LỆ LẬT THẺ JOKER</b></h2>

<div class="row">

                                            <div class="col-md-2 col-lg-2 col-xs-12">
                                                <label>2.999 Kim Cương</label>
                                            ...
                                            <div class="col-md-2 col-lg-2 col-xs-12">
                                                <label>GÃ HỀ JOKER 21 Kim Cương</label>
                                                <div class="form-group">

...
if(!$_SESSION['token']){
    ...
    mysqli_query($kun->connect_db(), "INSERT INTO `user_history_system` (`username`, `action`, `action_name`, `sotien`, `mota`, `time`, `history`, `hisnick`) VALUES ('".$user['username']."', 'Vòng Quay FreeFire', '".$vongquay['name']."', '-".number_format($vongquay['giatien'])."đ', 'Nhận được ".$kun->vongquaykimcuong_gift($id, $kundeptrai, 'kimcuong')." Kim Cương', '".time()."', '10', '0')");
    	// Update Tiền User

...
$row = mysqli_fetch_assoc(mysqli_query($kun->connect_db(), "SELECT * FROM `setting_latthe1`"));
...
switch ($kundeptrai) {
    case '1':
    $vongquay = 1;
    $img = '/assets/img/latthe1/1.png'; // 9,999 kc
        break;
    case '2':
    $vongquay = 2;
    $img = '/assets/img/latthe1/2.png';      // 399 kc
        break;
    case '3':
    $vongquay = 3;
    $img = '/assets/img/latthe1/3.png';      // 19,999 kc
        break;
    case '4':
    $vongquay = 4;
    $img = '/assets/img/latthe1/4.png';    // 99 kc
        break;
    case '5':
    $vongquay = 5;
    $img = '/assets/img/latthe1/5.png';   // 999 kc
        break;
    case '6':
    $vongquay = 6;
    $img = '/assets/img/latthe1/6.png';    // 14,999 kc
        break;
...
if($vongquay == 1){
    $gift = "Kết Quả: Bạn Trúng 9.999 Kim Cương"; 
    $kimcuong = 9999;
}elseif($vongquay == 2){
    $gift = "Kết Quả: Bạn Trúng Hoa Phượng Mùa Hè 19 Kim Cương";
    $kimcuong = 19;
}elseif($vongquay == 3){
    ...
    $gift = "Kết Quả: Bạn Trúng 14.9999 Kim Cương";
    $kimcuong = 14999;
}elseif($vongquay == 6){

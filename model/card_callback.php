...
$pusher = new Pusher('10d5ea7e7b632db09c72', 'a496a6f084ba9c65fffb', '234217', $options);
...
if ( isset($_GET['content']) && isset($_GET['status']) )
{
    ...
    if ($_GET['status'] == 'hoantat')
    {
        ...
        mysqli_query(
            $kun->connect_db(),
            "INSERT INTO `user_history_system` (`username`, `action`, `action_name`, `sotien`, `mota`, `time`) VALUES ('" .
                $get['username'] .
                "', 'Nạp Thẻ', 'Nạp Thẻ Tự Động', '+" .
                number_format($money) .
                "đ', 'Nạp Thẻ " .
                $get['type'] .
                " Thành Công!', '" .

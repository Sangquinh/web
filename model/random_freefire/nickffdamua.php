...
<div class="modal-body">
        <div class="form-horizontal">
            <div class="form-group m-t-10">
                <label class="col-md-3 control-label"><b><b class="text-danger">Tài khoản:</b></label>
                <div class="col-md-6">
                    <input class="form-control c-square c-theme" style="background: #fcfcfc;" type="text" placeholder="Tài khoản" readonly="" value="<?php echo $row['username'];?>">
                </div>
            </div>
            <div class="form-group m-t-10">
                <label class="col-md-3 control-label"><b><b class="text-danger">Mật khẩu:</b></label>
                <div class="col-md-6">
            ...
            <div class="form-group m-t-10">
                <label class="col-md-4 control-label"><b><b class="text-danger">Mã Login Facebook:</b></label>
                <div class="col-md-5">
            ...
            <div class="alert alert-danger c-font-black">
            ...
            <div class="alert alert-info c-font-black">
